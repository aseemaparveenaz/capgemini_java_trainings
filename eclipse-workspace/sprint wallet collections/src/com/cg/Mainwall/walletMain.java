	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			case 4:
				...
				LocalDateTime time = s1.get();
				Supplier<String> s2 = () -> dtf.format(LocalDateTime.now());
				String time2 = s2.get();
				System.out.println("From " +sourceid+ " successfully transferred to " +recepientid+ " on " +time2);
				System.out.println("Your current transaction status :" +res3 + " and balance is " +amount2);
